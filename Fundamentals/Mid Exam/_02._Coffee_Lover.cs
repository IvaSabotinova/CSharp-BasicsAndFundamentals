    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i <= numberofCommands; i++)
            {
                ...
                {
                    int numberOfCoffeesToRemove = int.Parse(commands[2]);
                    if (coffees.Count < numberOfCoffeesToRemove)
                    {
                        continue;
                    }
                    ...
                    if (commands[1] == "first")
                    {
                        coffees.RemoveRange(0, numberOfCoffeesToRemove);
                    }
                    else if (commands[1] == "last")
                    {
                        coffees.RemoveRange(coffees.Count - numberOfCoffeesToRemove, numberOfCoffeesToRemove);
                    }
                }
